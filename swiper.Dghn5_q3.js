...
function re(e={}, s={}) {
    ...
    Object.keys(s).filter(i => t.indexOf(i) < 0).forEach(i => {
        typeof e[i] > "u" ? e[i] = s[i] : ne(s[i]) && ne(e[i]) && Object.keys(s[i]).length > 0 && re(e[i], s[i])
    }
    )
}
const pe = {
...
function Pe(e, s="x") {
    ...
    i = n.toString().split(",")),
    s === "x" && (t.WebKitCSSMatrix ? r = n.m41 : i.length === 16 ? r = parseFloat(i[12]) : r = parseFloat(i[4])),
    s === "y" && (t.WebKitCSSMatrix ? r = n.m42 : i.length === 16 ? r = parseFloat(i[13]) : r = parseFloat(i[5])),
    r || 0
}
function W(e) {
    ...
    for (let i = 1; i < e.length; i += 1) {
        ...
        if (r != null && !Ce(r)) {
            ...
            for (let l = 0, o = n.length; l < o; l += 1) {
                ...
                d !== void 0 && d.enumerable && (W(s[a]) && W(r[a]) ? r[a].__swiper__ ? s[a] = r[a] : _(s[a], r[a]) : !W(s[a]) && W(r[a]) ? (s[a] = {},
                r[a].__swiper__ ? s[a] = r[a] : _(s[a], r[a])) : s[a] = r[a])
            }
        }
    }
    return s
...
function he({swiper: e, targetPosition: s, side: t}) {
    const i = G()
      , r = -e.translate;
    let n = null, l;
...
function se(e, s=[]) {
    ...
    return t.classList.add(...Array.isArray(s) ? s : xe(s)),
    t
}
function Oe(e, s) {
    const t = [];
...
function Ge({userAgent: e}={}) {
    ...
    return !d && u && s.touch && m.indexOf(`${l}x${o}`) >= 0 && (d = r.match(/(Version)\/([\d.]+)/),
    d || (d = [0, 1, "13_0_0"]),
    u = !1),
    a && !p && (n.os = "android",
    n.android = !0),
...
function De() {
    ...
    if (i()) {
        ...
        if (o.includes("Version/")) {
            const [a,d] = o.split("Version/")[1].split(" ")[0].split(".").map(f => Number(f));
            t = a < 16 || a === 16 && d < 2
        }
    }
...
function Ve({swiper: e, on: s, emit: t}) {
    const i = G();
    let r = null
      , n = null;
    const l = () => {
      ...
      , o = () => {
        !e || e.destroyed || !e.initialized || (r = new ResizeObserver(f => {
            n = i.requestAnimationFrame( () => {
                ...
                let u = c
                  , m = p;
                f.forEach( ({contentBoxSize: h, contentRect: E, target: b}) => {
                    b && b !== e.el || (u = E ? E.width : (h[0] || h).inlineSize,
                    m = E ? E.height : (h[0] || h).blockSize)
                }
                ),
                (u !== c || m !== p) && l()
            }
...
function Fe() {
    ...
    !(s === 0 && e.isHorizontal() || t === 0 && e.isVertical()) && (s = s - parseInt(H(i, "padding-left") || 0, 10) - parseInt(H(i, "padding-right") || 0, 10),
    t = t - parseInt(H(i, "padding-top") || 0, 10) - parseInt(H(i, "padding-bottom") || 0, 10),
    Number.isNaN(s) && (s = 0),
    Number.isNaN(t) && (t = 0),
    Object.assign(e, {
        width: s,
...
function Ne() {
    const e = this;
    function s(y, S) {
        return parseFloat(y.getPropertyValue(e.getDirectionLabel(S)) || 0)
    }
    const t = e.params
      , {wrapperEl: i, slidesEl: r, rtlTranslate: n, wrongRTL: l} = e
      , o = e.virtual && t.virtual.enabled
      , a = o ? e.virtual.slides.length : e.slides.length
      , d = $(r, `.${e.params.slideClass}, swiper-slide`)
    ...
    e.virtualSize = -g - m - h,
    d.forEach(y => {
        n ? y.style.marginLeft = "" : y.style.marginRight = "",
        y.style.marginBottom = "",
        y.style.marginTop = ""
    }
    ),
    t.centeredSlides && t.cssMode && (j(i, "--swiper-centered-offset-before", ""),
    j(i, "--swiper-centered-offset-after", ""));
    ...
    for (let y = 0; y < f; y += 1) {
        T = 0;
        const S = d[y];
        if (!(S && (P && e.grid.updateSlide(y, S, d),
        H(S, "display") === "none"))) {
            if (o && t.slidesPerView === "auto")
                t.virtual.slidesPerViewAutoSlideSize && (T = t.virtual.slidesPerViewAutoSlideSize),
                T && S && (t.roundLengths && (T = Math.floor(T)),
                S.style[e.getDirectionLabel("width")] = `${T}px`);
            else if (t.slidesPerView === "auto") {
                z && (S.style[e.getDirectionLabel("width")] = "");
                const C = getComputedStyle(S)
                  , k = S.style.transform
                  , D = S.style.webkitTransform;
                if (k && (S.style.transform = "none"),
                D && (S.style.webkitTransform = "none"),
                t.roundLengths)
                    T = e.isHorizontal() ? le(S, "width") : le(S, "height");
                else {
                    const B = s(C, "width")
                      , R = s(C, "padding-left")
                      , I = s(C, "padding-right")
                    ...
                    if (A && A === "border-box")
                        ...
                        const {clientWidth: F, offsetWidth: ye} = S;
                        T = B + R + I + x + O + (ye - F)
                    }
                }
                k && (S.style.transform = k),
                D && (S.style.webkitTransform = D),
                t.roundLengths && (T = Math.floor(T))
            } else
                T = (v - (t.slidesPerView - 1) * g) / t.slidesPerView,
                t.roundLengths && (T = Math.floor(T)),
                S && (S.style[e.getDirectionLabel("width")] = `${T}px`);
            S && (S.swiperSlideSize = T),
            u.push(T),
            t.centeredSlides ? (M = M + T / 2 + w / 2 + g,
            w === 0 && y !== 0 && (M = M - v / 2 - g),
            y === 0 && (M = M - v / 2 - g),
            Math.abs(M) < 1 / 1e3 && (M = 0),
            t.roundLengths && (M = Math.floor(M)),
            L % t.slidesPerGroup === 0 && c.push(M),
            p.push(M)) : (t.roundLengths && (M = Math.floor(M)),
            (L - Math.min(e.params.slidesPerGroupSkip, L)) % e.params.slidesPerGroup === 0 && c.push(M),
            p.push(M),
            M = M + T + g),
            e.virtualSize += T + g,
            w = T,
    ...
    if (e.virtualSize = Math.max(e.virtualSize, v) + h,
    n && l && (t.effect === "slide" || t.effect === "coverflow") && (i.style.width = `${e.virtualSize + g}px`),
    ...
    !t.centeredSlides) {
        ...
        for (let S = 0; S < c.length; S += 1) {
            ...
            c[S] <= e.virtualSize - v && y.push(C)
        }
        c = y,
        Math.floor(e.virtualSize - v) - Math.floor(c[c.length - 1]) > 1 && c.push(e.virtualSize - v)
    }
    if (o && t.loop) {
        const y = u[0] + g;
        if (t.slidesPerGroup > 1) {
            const S = Math.ceil((e.virtual.slidesBefore + e.virtual.slidesAfter) / t.slidesPerGroup)
              , C = y * t.slidesPerGroup;
            for (let k = 0; k < S; k += 1)
                c.push(c[c.length - 1] + C)
        }
        for (let S = 0; S < e.virtual.slidesBefore + e.virtual.slidesAfter; S += 1)
            t.slidesPerGroup === 1 && c.push(c[c.length - 1] + y),
            p.push(p[p.length - 1] + y),
            e.virtualSize += y
    }
    if (c.length === 0 && (c = [0]),
    g !== 0) {
        const y = e.isHorizontal() && n ? "marginLeft" : e.getDirectionLabel("marginRight");
        d.filter( (S, C) => !t.cssMode || t.loop ? !0 : C !== d.length - 1).forEach(S => {
            S.style[y] = `${g}px`
        }
        )
    }
    ...
    t.centeredSlides && t.cssMode && !t.centeredSlidesBounds) {
        j(i, "--swiper-centered-offset-before", `${-c[0]}px`),
        j(i, "--swiper-centered-offset-after", `${e.size / 2 - u[u.length - 1] / 2}px`);
        const y = -e.snapGrid[0]
          , S = -e.slidesGrid[0];
        e.snapGrid = e.snapGrid.map(C => C + y),
        e.slidesGrid = e.slidesGrid.map(C => C + S)
    }
    if (f !== a && e.emit("slidesLengthChange"),
    c.length !== E && (e.params.watchOverflow && e.checkOverflow(),
    ...
    !o && !t.cssMode && (t.effect === "slide" || t.effect === "fade")) {
        const y = `${t.containerModifierClass}backface-hidden`
          , S = e.el.classList.contains(y);
        f <= t.maxBackfaceHiddenSlides ? S || e.el.classList.add(y) : S && e.el.classList.remove(y)
    }
}
function $e(e) {
    const s = this
...
function Re(e=this && this.translate || 0) {
    const s = this
      , t = s.params
      , {slides: i, rtlTranslate: r, snapGrid: n} = s;
    if (i.length === 0)
        return;
    ...
    for (let a = 0; a < i.length; a += 1) {
        ...
        const c = (l + (t.centeredSlides ? s.minTranslate() : 0) - f) / (d.swiperSlideSize + o)
          , p = (l - n[0] + (t.centeredSlides ? s.minTranslate() : 0) - f) / (d.swiperSlideSize + o)
          , u = -(l - f)
          , m = u + s.slidesSizesGrid[a]
          , h = u >= 0 && u <= s.size - s.slidesSizesGrid[a]
          , E = u >= 0 && u < s.size - 1 || m > 1 && m <= s.size || u <= 0 && m >= s.size;
        E && (s.visibleSlides.push(d),
        s.visibleSlidesIndexes.push(a)),
        oe(d, E, t.slideVisibleClass),
        oe(d, h, t.slideFullyVisibleClass),
        d.progress = r ? -c : c,
...
function We(e) {
    const s = this;
    if (typeof e > "u") {
        const f = s.rtlTranslate ? -1 : 1;
        e = s && s.translate && s.translate * f || 0
    }
    const t = s.params
      , i = s.maxTranslate() - s.minTranslate();
    let {progress: r, isBeginning: n, isEnd: l, progressLoop: o} = s;
    const a = n
      , d = l;
    if (i === 0)
        r = 0,
        ...
        const f = Math.abs(e - s.minTranslate()) < 1
    ...
    n && !a && s.emit("reachBeginning toEdge"),
    l && !d && s.emit("reachEnd toEdge"),
    (a && !n || d && !l) && s.emit("fromEdge"),
    s.emit("progress", r)
}
const J = (e, s, t) => {
    s && !e.classList.contains(t) ? e.classList.add(t) : !s && e.classList.contains(t) && e.classList.remove(t)
...
function je() {
    const e = this
      , {slides: s, params: t, slidesEl: i, activeIndex: r} = e
      , n = e.virtual && t.virtual.enabled
      , l = e.grid && t.grid && t.grid.rows > 1
      , o = c => $(i, `.${t.slideClass}${c}, swiper-slide${c}`)[0];
    let a, d, f;
    if (n)
        if (t.loop) {
        ...
        l ? (a = s.find(c => c.column === r),
        f = s.find(c => c.column === r + 1),
        d = s.find(c => c.column === r - 1)) : a = s[r];
    a && (l || (f = ze(a, `.${t.slideClass}, swiper-slide`)[0],
    t.loop && !f && (f = s[0]),
    d = Oe(a, `.${t.slideClass}, swiper-slide`)[0],
    t.loop && !d === 0 && (d = s[s.length - 1]))),
    s.forEach(c => {
        J(c, c === a, t.slideActiveClass),
        J(c, c === f, t.slideNextClass),
...
const Y = (e, s) => {
    ...
    if (i) {
        ...
        !r && e.isElement && (i.shadowRoot ? r = i.shadowRoot.querySelector(`.${e.params.lazyPreloaderClass}`) : requestAnimationFrame( () => {
            i.shadowRoot && (r = i.shadowRoot.querySelector(`.${e.params.lazyPreloaderClass}`),
            r && r.remove())
        }
        )),
        r && r.remove()
...
function qe(e) {
    const s = this
      ...
      , {snapGrid: i, params: r, activeIndex: n, realIndex: l, snapIndex: o} = s;
    let a = e, d;
    const f = u => {
    ...
    if (s.virtual && r.virtual.enabled && r.loop)
        ...
        const u = s.slides.find(h => h.column === a);
    ...
    s.emit("snapIndexChange"),
    (s.initialized || s.params.runCallbacksOnInit) && (l !== p && s.emit("realIndexChange"),
    s.emit("slideChange"))
}
function Xe(e, s) {
    const t = this
...
function Ke(e=this.isHorizontal() ? "x" : "y") {
    const s = this
      , {params: t, rtlTranslate: i, translate: r, wrapperEl: n} = s;
...
function Qe(e, s) {
    const t = this
      , {rtlTranslate: i, params: r, wrapperEl: n, progress: l} = t;
    let o = 0
      , a = 0;
    const d = 0;
...
function et(e=0, s=this.params.speed, t=!0, i=!0, r) {
    ...
    return s === 0 ? (n.setTransition(0),
    n.setTranslate(f),
    t && (n.emit("beforeTransitionStart", s, r),
    n.emit("transitionEnd"))) : (n.setTransition(s),
    n.setTranslate(f),
    t && (n.emit("beforeTransitionStart", s, r),
...
function we({swiper: e, runCallbacks: s, direction: t, step: i}) {
    const {activeIndex: r, previousIndex: n} = e;
    let l = t;
    l || (r > n ? l = "next" : r < n ? l = "prev" : l = "reset"),
    e.emit(`transition${i}`),
    s && l === "reset" ? e.emit(`slideResetTransition${i}`) : s && r !== n && (e.emit(`slideChangeTransition${i}`),
...
function at(e=0, s, t=!0, i, r) {
    ...
    let l = e;
    l < 0 && (l = 0);
    const {params: o, snapGrid: a, slidesGrid: d, previousIndex: f, activeIndex: c, rtlTranslate: p, wrapperEl: u, enabled: m} = n;
    ...
    if (o.normalizeSlideIndex)
        for (let P = 0; P < d.length; P += 1) {
            const T = -Math.floor(b * 100)
              , z = Math.floor(d[P] * 100)
              , y = Math.floor(d[P + 1] * 100);
            typeof d[P + 1] < "u" ? T >= z && T < y - (y - z) / 2 ? l = P : T >= z && T < y && (l = P + 1) : T >= z && (l = P)
        }
    if (n.initialized && l !== c && (!n.allowSlideNext && (p ? b > n.translate && b > n.minTranslate() : b < n.translate && b < n.minTranslate()) || !n.allowSlidePrev && b > n.translate && b > n.maxTranslate() && (c || 0) !== l))
        return !1;
    ...
    if (!(g && r) && (p && -b === n.translate || !p && b === n.translate))
    ...
    const L = Se().isSafari;
    return g && !r && L && n.isElement && n.virtual.update(!1, !1, l),
    n.setTransition(s),
    n.setTranslate(b),
    ...
    s === 0 ? n.transitionEnd(t, v) : n.animating || (n.animating = !0,
    ...
    if (r.params.loop)
        if (r.virtual && r.params.virtual.enabled)
            ...
            if (n) {
                ...
                o = r.slides.find(E => E.getAttribute("data-swiper-slide-index") * 1 === h).column
            } else
            ...
            p && u % 2 === 0 && (u = u + 1));
            let m = a - o < u;
            if (p && (m = m || o < Math.ceil(u / 2)),
            i && p && r.params.slidesPerView !== "auto" && !n && (m = !1),
            m) {
                const h = p ? o < r.activeIndex ? "prev" : "next" : o - r.activeIndex - 1 < r.params.slidesPerView ? "next" : "prev";
                r.loopFix({
                    direction: h,
                    slideTo: !0,
            ...
            if (n) {
                const h = l * r.params.grid.rows;
                l = r.slides.find(E => E.getAttribute("data-swiper-slide-index") * 1 === h).column
            } else
...
function ot(e, s=!0, t) {
    ...
    const a = i.activeIndex < n.slidesPerGroupSkip ? 1 : o
...
function dt(e, s=!0, t) {
    const i = this
      , {params: r, snapGrid: n, slidesGrid: l, rtlTranslate: o, enabled: a, animating: d} = i;
    if (!a || i.destroyed)
        return i;
    typeof e > "u" && (e = i.params.speed);
    ...
    if (typeof E > "u" && (r.cssMode || h)) {
        ...
        typeof v < "u" && (E = h ? n[v] : n[v > 0 ? v - 1 : v])
    }
    let b = 0;
    if (typeof E < "u" && (b = l.indexOf(E),
    b < 0 && (b = i.activeIndex - 1),
    r.slidesPerView === "auto" && r.slidesPerGroup === 1 && r.slidesPerGroupAuto && (b = b - i.slidesPerViewDynamic("previous", !0) + 1,
    b = Math.max(b, 0))),
...
function ut(e, s=!0, t, i=.5) {
    ...
    if (a >= r.snapGrid[o]) {
        const d = r.snapGrid[o]
          , f = r.snapGrid[o + 1];
        a - d > (f - d) * i && (n += r.params.slidesPerGroup)
    } else {
...
function ft() {
    ...
    if (s.loop) {
        ...
        s.centeredSlides ? e.slideToLoop(n) : r > (o ? (e.slides.length - i) / 2 - (e.params.grid.rows - 1) : e.slides.length - i) ? (e.loopFix(),
        r = e.getSlideIndex($(t, `${l}[data-swiper-slide-index="${n}"]`)[0]),
        me( () => {
            e.slideTo(r)
        }
        )) : e.slideTo(r)
...
function mt(e, s) {
    ...
    if (!i.loop || t.virtual && t.params.virtual.enabled)
        return;
    const n = () => {
        $(r, `.${i.slideClass}, swiper-slide`).forEach( (m, h) => {
            m.setAttribute("data-swiper-slide-index", h)
        }
        )
    }
      , l = () => {
        const u = $(r, `.${i.slideBlankClass}`);
        u.forEach(m => {
            m.remove()
        }
        ),
    ...
    const a = i.slidesPerGroup * (o ? i.grid.rows : 1)
      ...
      , c = u => {
        for (let m = 0; m < u; m += 1) {
            const h = t.isElement ? se("swiper-slide", [i.slideBlankClass]) : se("div", [i.slideClass, i.slideBlankClass]);
            t.slidesEl.append(h)
        }
    }
    ;
...
function ht({slideRealIndex: e, slideTo: s=!0, direction: t, setTranslate: i, activeSlideIndex: r, initial: n, byController: l, byMousewheel: o}={}) {
    const a = this;
    if (!a.params.loop)
        return;
    a.emit("beforeLoopFix");
    const {slides: d, allowSlidePrev: f, allowSlideNext: c, slidesEl: p, params: u} = a
      , {centeredSlides: m, slidesOffsetBefore: h, slidesOffsetAfter: E, initialSlide: b} = u
      , v = m || !!h || !!E;
    if (a.allowSlidePrev = !0,
    a.allowSlideNext = !0,
    a.virtual && u.virtual.enabled) {
        s && (!v && a.snapIndex === 0 ? a.slideTo(a.virtual.slides.length, 0, !1, !0) : v && a.snapIndex < u.slidesPerView ? a.slideTo(a.virtual.slides.length + a.snapIndex, 0, !1, !0) : a.snapIndex === a.snapGrid.length - 1 && a.slideTo(a.virtual.slidesBefore, 0, !1, !0)),
        a.allowSlidePrev = f,
        a.allowSlideNext = c,
        a.emit("loopFix");
        return
    ...
    g === "auto" ? g = a.slidesPerViewDynamic() : (g = Math.ceil(parseFloat(u.slidesPerView, 10)),
    v && g % 2 === 0 && (g = g + 1));
    const M = u.slidesPerGroupAuto ? g : u.slidesPerGroup;
    let w = v ? Math.max(M, Math.ceil(g / 2)) : M;
    w % M !== 0 && (w += M - w % M),
    w += u.loopAdditionalSlides,
    a.loopedSlides = w;
    const L = a.grid && u.grid && u.grid.rows > 1;
    d.length < g + w || a.params.effect === "cards" && d.length < g + w * 2 ? X("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled or not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters") : L && u.grid.fill === "row" && X("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
    const P = []
      , T = []
      , z = L ? Math.ceil(d.length / u.grid.rows) : d.length
      , y = n && z - b < g && !v;
    let S = y ? b : a.activeIndex;
    typeof r > "u" ? r = a.getSlideIndex(d.find(x => x.classList.contains(u.slideActiveClass))) : S = r;
    const C = t === "next" || !t
      , k = t === "prev" || !t;
    let D = 0
      , B = 0;
    const I = (L ? d[r].column : r) + (v && typeof i > "u" ? -g / 2 + .5 : 0);
    if (I < w) {
        D = Math.max(w - I, M);
        for (let x = 0; x < w - I; x += 1) {
            const O = x - Math.floor(x / z) * z;
            if (L) {
                const A = z - O - 1;
                for (let F = d.length - 1; F >= 0; F -= 1)
                    d[F].column === A && P.push(F)
            } else
                P.push(z - O - 1)
        }
    } else if (I + g > z - w) {
        B = Math.max(I - (z - w * 2), M),
        y && (B = Math.max(B, g - z + b + 1));
        for (let x = 0; x < B; x += 1) {
            const O = x - Math.floor(x / z) * z;
            L ? d.forEach( (A, F) => {
                A.column === O && T.push(F)
    ...
    a.params.effect === "cards" && d.length < g + w * 2 && (T.includes(r) && T.splice(T.indexOf(r), 1),
    ...
    a.recalcSlides(),
    u.slidesPerView === "auto" ? a.updateSlides() : L && (P.length > 0 && k || T.length > 0 && C) && a.slides.forEach( (x, O) => {
        a.grid.updateSlide(O, x, a.slides)
    }
    ),
        ...
        if (P.length > 0 && k) {
            if (typeof e > "u") {
                const x = a.slidesGrid[S]
                  , A = a.slidesGrid[S + D] - x;
                o ? a.setTranslate(a.translate - A) : (a.slideTo(S + Math.ceil(D), 0, !1, !0),
                i && (a.touchEventsData.startTranslate = a.touchEventsData.startTranslate - A,
                a.touchEventsData.currentTranslate = a.touchEventsData.currentTranslate - A))
            } else if (i) {
                const x = L ? P.length / u.grid.rows : P.length;
            ...
            if (typeof e > "u") {
                const x = a.slidesGrid[S]
                  , A = a.slidesGrid[S - B] - x;
                o ? a.setTranslate(a.translate - A) : (a.slideTo(S - B, 0, !1, !0),
                i && (a.touchEventsData.startTranslate = a.touchEventsData.startTranslate - A,
                a.touchEventsData.currentTranslate = a.touchEventsData.currentTranslate - A))
            } else {
                const x = L ? T.length / u.grid.rows : T.length;
                a.slideTo(a.activeIndex - x, 0, !1, !0)
            }
    }
    ...
    a.controller && a.controller.control && !l) {
        ...
        Array.isArray(a.controller.control) ? a.controller.control.forEach(O => {
            !O.destroyed && O.params.loop && O.loopFix({
                ...x,
                slideTo: O.params.slidesPerView === u.slidesPerView ? s : !1
            })
        }
...
function de(e, s, t) {
    ...
    return n && (t <= l || t >= i.innerWidth - l) ? n === "prevent" ? (s.preventDefault(),
    !0) : !1 : !0
}
function bt(e) {
    const s = this
    ...
    let a = i.target;
    if (n.touchEventsTarget === "wrapper" && !Le(a, s.wrapperEl) || "which"in i && i.which === 3 || "button"in i && i.button > 0 || r.isTouched && r.isMoved)
        return;
    const d = !!n.noSwipingClass && n.noSwipingClass !== ""
      , f = i.composedPath ? i.composedPath() : i.path;
    d && i.target && i.target.shadowRoot && f && (a = f[0]);
    const c = n.noSwipingSelector ? n.noSwipingSelector : `.${n.noSwipingClass}`
      , p = !!(i.target && i.target.shadowRoot);
    if (n.noSwiping && (p ? yt(c, a) : a.closest(c))) {
        s.allowClick = !0;
        return
    }
    ...
    t.activeElement && t.activeElement.matches(r.focusableElements) && t.activeElement !== a && (i.pointerType === "mouse" || i.pointerType !== "mouse" && !a.matches(r.focusableElements)) && t.activeElement.blur();
    const E = h && s.allowTouchMove && n.touchStartPreventDefault;
    (n.touchStartForcePreventDefault || E) && !a.isContentEditable && i.preventDefault(),
    n.freeMode && n.freeMode.enabled && s.freeMode && s.animating && !n.cssMode && s.freeMode.onTouchStart(),
    s.emit("touchStart", i)
}
function xt(e) {
    const s = N()
    ...
    let d;
    if (a.type === "touchmove") {
        if (d = [...a.changedTouches].find(w => w.identifier === i.touchId),
    ...
    if (r.touchReleaseOnEdges && !r.loop)
        if (t.isVertical()) {
            ...
            if (l && (f > n.startX && -t.translate <= t.maxTranslate() || f < n.startX && -t.translate >= t.minTranslate()))
                return;
            if (!l && (f < n.startX && t.translate <= t.maxTranslate() || f > n.startX && t.translate >= t.minTranslate()))
                return
        }
    ...
    if (typeof i.isScrolling > "u") {
        let w;
        t.isHorizontal() && n.currentY === n.startY || t.isVertical() && n.currentX === n.startX ? i.isScrolling = !1 : p * p + u * u >= 25 && (w = Math.atan2(Math.abs(u), Math.abs(p)) * 180 / Math.PI,
        i.isScrolling = t.isHorizontal() ? w > r.touchAngle : 90 - w > r.touchAngle)
    }
    ...
    if (new Date().getTime(),
    r._loopSwapReset !== !1 && i.isMoved && i.allowThresholdMove && E !== t.touchesDirection && b && v && Math.abs(m) >= 1) {
        Object.assign(n, {
            startX: f,
            startY: c,
            currentX: f,
    ...
    m > 0 ? (b && v && i.allowThresholdMove && i.currentTranslate > (r.centeredSlides ? t.minTranslate() - t.slidesSizesGrid[t.activeIndex + 1] - (r.slidesPerView !== "auto" && t.slides.length - r.slidesPerView >= 2 ? t.slidesSizesGrid[t.activeIndex + 1] + t.params.spaceBetween : 0) - t.params.spaceBetween : t.minTranslate()) && t.loopFix({
        direction: "prev",
        setTranslate: !0,
        activeSlideIndex: 0
    }),
    ...
    r.resistance && (i.currentTranslate = t.maxTranslate() + 1 - (t.maxTranslate() - i.startTranslate - m) ** M))),
...
function Et(e) {
    ...
    if (i.type === "touchend" || i.type === "touchcancel") {
        if (r = [...i.changedTouches].find(w => w.identifier === t.touchId),
    ...
    t.pointerId = null,
    t.touchId = null;
    const {params: l, touches: o, rtlTranslate: a, slidesGrid: d, enabled: f} = s;
    if (!f || !l.simulateTouch && i.pointerType === "mouse")
        return;
    ...
    if (s.allowClick) {
        ...
        s.updateClickedSlide(w && w[0] || i.target, w),
        s.emit("tap click", i),
        p < 300 && c - t.lastClickTime < 300 && s.emit("doubleTap doubleClick", i)
    }
    if (t.lastClickTime = q(),
    me( () => {
    ...
    t.startMoving = !1;
    let u;
    if (l.followFinger ? u = a ? s.translate : -s.translate : u = -t.currentTranslate,
    l.cssMode)
        return;
    ...
    for (let w = 0; w < d.length; w += w < l.slidesPerGroupSkip ? 1 : l.slidesPerGroup) {
        const L = w < l.slidesPerGroupSkip - 1 ? 1 : l.slidesPerGroup;
        typeof d[w + L] < "u" ? (m || u >= d[w] && u < d[w + L]) && (h = w,
        E = d[w + L] - d[w]) : (m || u >= d[w]) && (h = w,
        E = d[d.length - 1] - d[d.length - 2])
    }
    let b = null
      , v = null;
    l.rewind && (s.isBeginning ? v = l.virtual && l.virtual.enabled && s.virtual ? s.virtual.slides.length - 1 : s.slides.length - 1 : s.isEnd && (b = 0));
    const g = (u - d[h]) / E
      , M = h < l.slidesPerGroupSkip - 1 ? 1 : l.slidesPerGroup;
    if (p > l.longSwipesMs) {
        if (!l.longSwipes) {
            s.slideTo(s.activeIndex);
            return
        }
        s.swipeDirection === "next" && (g >= l.longSwipesRatio ? s.slideTo(l.rewind && s.isEnd ? b : h + M) : s.slideTo(h)),
        s.swipeDirection === "prev" && (g > 1 - l.longSwipesRatio ? s.slideTo(h + M) : v !== null && g < 0 && Math.abs(g) > l.longSwipesRatio ? s.slideTo(v) : s.slideTo(h))
    } else {
        if (!l.shortSwipes) {
            s.slideTo(s.activeIndex);
            return
        }
        s.navigation && (i.target === s.navigation.nextEl || i.target === s.navigation.prevEl) ? i.target === s.navigation.nextEl ? s.slideTo(h + M) : s.slideTo(h) : (s.swipeDirection === "next" && s.slideTo(b !== null ? b : h + M),
        s.swipeDirection === "prev" && s.slideTo(v !== null ? v : h))
    }
}
function ce() {
    const e = this
...
const Te = (e, s) => {
    ...
    i.cssMode && n[a]("scroll", e.onScroll),
    i.updateOnWindowResize ? e[d](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", ce, !0) : e[d]("observerUpdate", ce, !0),
    r[a]("load", e.onLoad, {
        capture: !0
    }))
}
...
const ue = (e, s) => e.grid && s.grid && s.grid.rows > 1;
function At() {
    const e = this
      , {realIndex: s, initialized: t, params: i, el: r} = e
      , n = i.breakpoints;
    ...
    const b = c.direction && c.direction !== i.direction
      , v = i.loop && (c.slidesPerView !== i.slidesPerView || b)
      , g = i.loop;
    ...
    E && !M ? e.disable() : !E && M && e.enable(),
    e.currentBreakpoint = d,
    e.emit("_beforeBreakpoint", c),
    t && (v ? (e.loopDestroy(),
    e.loopCreate(s),
    e.updateSlides()) : !g && w ? (e.loopCreate(s),
...
function kt(e, s="window", t) {
    ...
    let i = !1;
    const r = G()
      , n = s === "window" ? r.innerHeight : t.clientHeight
...
function Vt() {
    const e = this
      , {classNames: s, params: t, rtl: i, el: r, device: n} = e
      , l = Dt(["initialized", t.direction, {
...
class V {
    ...
    recalcSlides() {
        ...
        s.slides = $(t, `.${i.slideClass}, swiper-slide`)
    }
    enable() {
        const s = this;
    ...
    slidesPerViewDynamic(s="current", t=!1) {
        const i = this
          , {params: r, slides: n, slidesGrid: l, slidesSizesGrid: o, size: a, activeIndex: d} = i;
        let f = 1;
    ...
    changeDirection(s, t=!0) {
        ...
        return s || (s = r === "horizontal" ? "vertical" : "horizontal"),
        s === r || s !== "horizontal" && s !== "vertical" || (i.el.classList.remove(`${i.params.containerModifierClass}${r}`),
    ...
    mount(s) {
        ...
        let l = i && i.shadowRoot && i.shadowRoot.querySelector ? i.shadowRoot.querySelector(r()) : $(i, r())[0];
        return !l && t.params.createElements && (l = se("div", t.params.wrapperClass),
        i.append(l),
        $(i, `.${t.params.slideClass}`).forEach(o => {
            l.append(o)
        }
        )),
        Object.assign(t, {
    ...
    init(s) {
        ...
        r.forEach(n => {
            n.complete ? Y(t, n) : n.addEventListener("load", l => {
                Y(t, l.target)
            }
            )
        }
    ...
    destroy(s=!0, t=!0) {
        const i = this
          , {params: r, el: n, wrapperEl: l, slides: o} = i;
    ...
    static use(s) {
        return Array.isArray(s) ? (s.forEach(t => V.installModule(t)),
        V) : (V.installModule(s),
        V)
    }
}
...
function Ht({swiper: e, extendParams: s, on: t, emit: i, params: r}) {
    e.autoplay = {
        running: !1,
        paused: !1,
        timeLeft: 0
    ...
    let n, l, o = r && r.autoplay ? r.autoplay.delay : 3e3, a = r && r.autoplay ? r.autoplay.delay : 3e3, d, f = new Date().getTime(), c, p, u, m, h, E, b;
    function v(I) {
        !e || e.destroyed || !e.wrapperEl || I.target === e.wrapperEl && (e.wrapperEl.removeEventListener("transitionend", v),
        !(b || I.detail && I.detail.bySwiperTouchMove) && z())
    }
    const g = () => {
        if (e.destroyed || !e.autoplay.running)
            return;
        e.autoplay.paused ? c = !0 : c && (a = d,
        c = !1);
        const I = e.autoplay.paused ? d : f + a - new Date().getTime();
        e.autoplay.timeLeft = I,
        i("autoplayTimeLeft", I, I / o),
      ...
      , M = () => {
        let I;
        return e.virtual && e.params.virtual.enabled ? I = e.slides.find(O => O.classList.contains("swiper-slide-active")) : I = e.slides[e.activeIndex],
      ...
      , w = I => {
        ...
        g();
        let x = typeof I > "u" ? e.params.autoplay.delay : I;
        o = e.params.autoplay.delay,
        a = e.params.autoplay.delay;
        const O = M();
        !Number.isNaN(O) && O > 0 && typeof I > "u" && (x = O,
        o = O,
        a = O),
        d = x;
        const A = e.params.speed
          , F = () => {
            ...
            i("autoplay")) : e.params.autoplay.stopOnLastSlide || (e.slideTo(e.slides.length - 1, A, !0, !0),
            i("autoplay")) : !e.isEnd || e.params.loop || e.params.rewind ? (e.slideNext(A, !0, !0),
            i("autoplay")) : e.params.autoplay.stopOnLastSlide || (e.slideTo(0, A, !0, !0),
            i("autoplay")),
      ...
      , T = (I, x) => {
        ...
        const O = () => {
            i("autoplayPause"),
            e.params.autoplay.waitForTransition ? e.wrapperEl.addEventListener("transitionend", v) : z()
        }
        ;
        if (e.autoplay.paused = !0,
        x) {
            h && (d = e.params.autoplay.delay),
            h = !1,
            O();
            return
        }
        d = (d || e.params.autoplay.delay) - (new Date().getTime() - f),
        !(e.isEnd && d < 0 && !e.params.loop) && (d < 0 && (d = 0),
        O())
    }
      , z = () => {
        e.isEnd && d < 0 && !e.params.loop || e.destroyed || !e.autoplay.running || (f = new Date().getTime(),
        E ? (E = !1,
        w(d)) : w(),
        e.autoplay.paused = !1,
        i("autoplayResume"))
      ...
      , y = () => {
        if (e.destroyed || !e.autoplay.running)
            return;
        const I = N();
        I.visibilityState === "hidden" && (E = !0,
        T(!0)),
        I.visibilityState === "visible" && z()
    }
      , S = I => {
        I.pointerType === "mouse" && (E = !0,
        b = !0,
        !(e.animating || e.autoplay.paused) && T(!0))
    }
      , C = I => {
        I.pointerType === "mouse" && (b = !1,
        e.autoplay.paused && z())
    }
      , k = () => {
        e.params.autoplay.pauseOnMouseEnter && (e.el.addEventListener("pointerenter", S),
        e.el.addEventListener("pointerleave", C))
    }
      , D = () => {
        e.el && typeof e.el != "string" && (e.el.removeEventListener("pointerenter", S),
        e.el.removeEventListener("pointerleave", C))
    }
      , B = () => {
        N().addEventListener("visibilitychange", y)
    }
      , R = () => {
        N().removeEventListener("visibilitychange", y)
    }
    ;
    t("init", () => {
        e.params.autoplay.enabled && (k(),
        B(),
        L())
    }
    ),
    ...
    t("_freeModeNoMomentumRelease", () => {
        e.params.autoplay.disableOnInteraction ? P() : T(!0, !0)
    }
    ),
    t("beforeTransitionStart", (I, x, O) => {
        e.destroyed || !e.autoplay.running || (O || !e.params.autoplay.disableOnInteraction ? T(!0, !0) : P())
    }
    ),
    t("sliderFirstMove", () => {
        if (!(e.destroyed || !e.autoplay.running)) {
